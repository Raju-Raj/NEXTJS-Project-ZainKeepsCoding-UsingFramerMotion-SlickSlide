            ...
            <div className="wwi-container">
                ...
                <div className="wwi-left">
                    <div className="head">
                        ...
                        <motion.span variants={titleVariants} initial="offscreen" whileInView="onscreen" className='title'>Digital Businesses With early Traction</motion.span>
                    </div>
                    ...
                    <div className="wwi-features">
                        {
                            whoWeInvest.map((feature,i)=>(
                                <motion.div 
                                variants={containerVariants(i*0.05+1)} initial="offscreen" whileInView="onscreen"
                                key={i} className='wwi-feature'>
